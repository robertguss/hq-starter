...
tags:
  - library
title: "How to C (as of 2016)"
url: "https://matt.sh/howto-c"
company: [personal]
topics: []
created: 2025-09-01
source_type: raindrop
raindrop_id: 1321406923
source_domain: "matt.sh"
...
URL Source: https://matt.sh/howto-c
...
_(Update: Many people have submitted revisions, notes, and improvements. All contributions have been incorporated throughout the page below.)_
...
_[Chinese InfoQ](https://www.infoq.com/cn/) provides a Chinese translation at [C语言的2016](http://www.infoq.com/cn/articles/c-language-2016)._

_[Programmer Magazine](http://www.csdn.net/tag/C%E8%AF%AD%E8%A8%80/news) provides a Chinese translation at [2016年，C语言该怎样写](http://geek.csdn.net/news/detail/63135) (as [PDF too](https://matt.sh/files/howtoc/howto-c-programmer-magazine.pdf))._
...
_[Nick Galbreath](https://twitter.com/NGalbreath) collected some relevant links about [overall C programming](http://www.client9.com/article/how-to-program-in-c/) as well._
...
Some readers have pointed out they truly love `int` and you’ll have to pry it from their cold dead fingers. I’d like to point out it is technically _impossible_ to program correctly if the sizes of your types change out from under you.
...
-[Matt](mailto:matt@matt.sh) — [☁mattsta](https://github.com/mattsta)
...
Jo Booth pointed out I like to spell compatibility as compatibility, which seems more logical, but English commonality disagrees.
...
[Nick Galbreath](https://twitter.com/NGalbreath) used [misspell](https://github.com/client9/misspell) to discover four more sneaky misspellings.

Merlin Büge also discovered one more language typo sitting here still in 2025!
