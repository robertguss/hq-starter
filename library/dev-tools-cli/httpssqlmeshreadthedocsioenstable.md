...
tags:
  - library
title: "https://sqlmesh.readthedocs.io/en/stable/"
url: "https://sqlmesh.readthedocs.io/en/stable/"
company: [personal]
topics: []
created: 2025-08-16
source_type: raindrop
raindrop_id: 1302011952
source_domain: "sqlmesh.readthedocs.io"
...
URL Source: https://sqlmesh.readthedocs.io/en/stable/

Markdown Content:
[![Image 1: SQLMesh logo](https://github.com/TobikoData/sqlmesh/blob/main/docs/readme/sqlmesh.png?raw=true)](https://github.com/TobikoData/sqlmesh/blob/main/docs/readme/sqlmesh.png?raw=true)
...
[![Image 2: Architecture Diagram](https://github.com/TobikoData/sqlmesh/blob/main/docs/readme/architecture_diagram.png?raw=true)](https://github.com/TobikoData/sqlmesh/blob/main/docs/readme/architecture_diagram.png?raw=true)

## Core Features

[![Image 3: SQLMesh Plan Mode](https://github.com/TobikoData/sqlmesh-public-assets/blob/main/sqlmesh_plan_mode.gif?raw=true)](https://github.com/TobikoData/sqlmesh-public-assets/blob/main/sqlmesh_plan_mode.gif?raw=true)
...
Level Up Your SQL
Write SQL in any dialect and SQLMesh will transpile it to your target SQL dialect on the fly before sending it to the warehouse. [![Image 4: Transpile Example](https://github.com/TobikoData/sqlmesh/blob/main/docs/readme/transpile_example.png?raw=true)](https://github.com/TobikoData/sqlmesh/blob/main/docs/readme/transpile_example.png?raw=true)

*   Debug transformation errors _before_ you run them in your warehouse in [10+ different SQL dialects](https://sqlmesh.readthedocs.io/en/stable/integrations/overview/#execution-engines)
