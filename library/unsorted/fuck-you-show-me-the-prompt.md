...
url: "https://hamel.dev/blog/posts/prompt/?ref=codeandcontext.ai"
company: [personal]
topics: []
created: 2026-04-21
source_type: raindrop
raindrop_id: 1691694125
...
![](https://hamel.dev/blog/posts/prompt/slap_3.jpeg)
...
3. Next, you need to configure your device (i.e. your laptop) to route all traffic through `mitproxy`, which listens on `http://localhost:8080`. Per the documentation:
	...
	![](https://hamel.dev/blog/posts/prompt/mac.png)
...
![](https://hamel.dev/blog/posts/prompt/mitm_01.png)
...
1. Two *seperate* api calls for each “idea”.
...
[^1]: You don’t have to whisper. Saying it out loud is fine too - let others know!
