...
URL Source: https://hermes-agent.nousresearch.com/docs/guides/tips/
...
## Getting the Best Results[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#getting-the-best-results "Direct link to Getting the Best Results")

### Be Specific About What You Want[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#be-specific-about-what-you-want "Direct link to Be Specific About What You Want")
...
### Provide Context Up Front[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#provide-context-up-front "Direct link to Provide Context Up Front")
...
### Use Context Files for Recurring Instructions[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-context-files-for-recurring-instructions "Direct link to Use Context Files for Recurring Instructions")
...
### Let the Agent Use Its Tools[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#let-the-agent-use-its-tools "Direct link to Let the Agent Use Its Tools")
...
### Use Skills for Complex Workflows[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-skills-for-complex-workflows "Direct link to Use Skills for Complex Workflows")
...
## CLI Power User Tips[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#cli-power-user-tips "Direct link to CLI Power User Tips")

### Multi-Line Input[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#multi-line-input "Direct link to Multi-Line Input")
...
### Paste Detection[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#paste-detection "Direct link to Paste Detection")
...
### Interrupt and Redirect[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#interrupt-and-redirect "Direct link to Interrupt and Redirect")
...
### Resume Sessions with `-c`[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#resume-sessions-with--c "Direct link to resume-sessions-with--c")
...
### Clipboard Image Paste[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#clipboard-image-paste "Direct link to Clipboard Image Paste")
...
### Slash Command Autocomplete[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#slash-command-autocomplete "Direct link to Slash Command Autocomplete")
...
## Context Files[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#context-files "Direct link to Context Files")

### AGENTS.md: Your Project's Brain[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#agentsmd-your-projects-brain "Direct link to AGENTS.md: Your Project's Brain")
...
### SOUL.md: Customize Personality[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#soulmd-customize-personality "Direct link to SOUL.md: Customize Personality")
...
For a full walkthrough, see [Use SOUL.md with Hermes](https://hermes-agent.nousresearch.com/docs/guides/use-soul-with-hermes).
...
### .cursorrules Compatibility[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#cursorrules-compatibility "Direct link to .cursorrules Compatibility")
...
### Discovery[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#discovery "Direct link to Discovery")
...
## Memory & Skills[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#memory--skills "Direct link to Memory & Skills")

### Memory vs. Skills: What Goes Where[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#memory-vs-skills-what-goes-where "Direct link to Memory vs. Skills: What Goes Where")
...
### When to Create Skills[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#when-to-create-skills "Direct link to When to Create Skills")
...
### Managing Memory Capacity[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#managing-memory-capacity "Direct link to Managing Memory Capacity")
...
### Let the Agent Remember[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#let-the-agent-remember "Direct link to Let the Agent Remember")
...
## Performance & Cost[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#performance--cost "Direct link to Performance & Cost")

### Don't Break the Prompt Cache[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#dont-break-the-prompt-cache "Direct link to Don't Break the Prompt Cache")
...
### Use /compress Before Hitting Limits[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-compress-before-hitting-limits "Direct link to Use /compress Before Hitting Limits")
...
### Delegate for Parallel Work[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#delegate-for-parallel-work "Direct link to Delegate for Parallel Work")
...
### Use execute_code for Batch Operations[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-execute_code-for-batch-operations "Direct link to Use execute_code for Batch Operations")
...
### Choose the Right Model[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#choose-the-right-model "Direct link to Choose the Right Model")
...
## Messaging Tips[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#messaging-tips "Direct link to Messaging Tips")

### Set a Home Channel[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#set-a-home-channel "Direct link to Set a Home Channel")
...
### Use /title to Organize Sessions[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-title-to-organize-sessions "Direct link to Use /title to Organize Sessions")
...
### DM Pairing for Team Access[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#dm-pairing-for-team-access "Direct link to DM Pairing for Team Access")
...
### Tool Progress Display Modes[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#tool-progress-display-modes "Direct link to Tool Progress Display Modes")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#security "Direct link to Security")

### Use Docker for Untrusted Code[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-docker-for-untrusted-code "Direct link to Use Docker for Untrusted Code")
...
### Avoid Windows Encoding Pitfalls[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#avoid-windows-encoding-pitfalls "Direct link to Avoid Windows Encoding Pitfalls")
...
### Review Before Choosing "Always"[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#review-before-choosing-always "Direct link to Review Before Choosing \"Always\"")
...
### Command Approval Is Your Safety Net[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#command-approval-is-your-safety-net "Direct link to Command Approval Is Your Safety Net")
...
### Use Allowlists for Messaging Bots[​](https://hermes-agent.nousresearch.com/docs/guides/tips/#use-allowlists-for-messaging-bots "Direct link to Use Allowlists for Messaging Bots")
