...
tags:
  - library
title: "https://marketplace.visualstudio.com/items?itemName=pablodelucca.pixel-agents"
url: "https://marketplace.visualstudio.com/items?itemName=pablodelucca.pixel-agents"
company: [personal]
topics: []
created: 2026-02-25
source_type: raindrop
raindrop_id: 1617589788
source_domain: "marketplace.visualstudio.com"
...
Title: Pixel Agents - Visual Studio Marketplace

URL Source: https://marketplace.visualstudio.com/items?itemName=pablodelucca.pixel-agents

Markdown Content:
## [![Image 1: Pixel Agents](https://github.com/pablodelucca/pixel-agents/raw/HEAD/webview-ui/public/banner.png)](https://github.com/pablodelucca/pixel-agents/discussions)

## The game interface where AI agents build real things

[![Image 2: version](https://img.shields.io/endpoint?url=https:%2f%2fgist.githubusercontent.com%2fpablodelucca%2f3cd28398fa4a2c0a636e1d51d41aee39%2fraw%2fversion.json)](https://github.com/pablodelucca/pixel-agents/releases)[![Image 3: marketplaces](https://img.shields.io/endpoint?url=https:%2f%2fgist.githubusercontent.com%2fpablodelucca%2f3cd28398fa4a2c0a636e1d51d41aee39%2fraw%2finstalls.json)](https://marketplace.visualstudio.com/items?itemName=pablodelucca.pixel-agents)[![Image 4: stars](https://img.shields.io/github/stars/pablodelucca/pixel-agents?logo=github&color=0183ff&style=flat)](https://github.com/pablodelucca/pixel-agents/stargazers)[![Image 5: license](https://img.shields.io/github/license/pablodelucca/pixel-agents?color=0183ff&style=flat)](https://github.com/pablodelucca/pixel-agents/blob/main/LICENSE)[![Image 6: good first issues](https://img.shields.io/github/issues/pablodelucca/pixel-agents/good%20first%20issue?color=7057ff&label=good%20first%20issues)](https://github.com/pablodelucca/pixel-agents/issues?q=is:open+is:issue+label:%22good+first+issue%22)
...
![Image 7: Pixel Agents screenshot](https://github.com/pablodelucca/pixel-agents/raw/HEAD/webview-ui/public/Screenshot.jpg)
...
![Image 8: Pixel Agents characters](https://github.com/pablodelucca/pixel-agents/raw/HEAD/webview-ui/public/characters.png)
...
To use furniture from an external directory, open Settings → **Add Asset Directory**. See [docs/external-assets.md](https://github.com/pablodelucca/pixel-agents/blob/HEAD/docs/external-assets.md) for the full manifest format and how to use third-party asset packs.
...
See [CONTRIBUTING.md](https://github.com/pablodelucca/pixel-agents/blob/HEAD/CONTRIBUTING.md) for instructions on how to contribute.

Please read our [Code of Conduct](https://github.com/pablodelucca/pixel-agents/blob/HEAD/CODE_OF_CONDUCT.md) before participating.

## Supporting the Project

If you find Pixel Agents useful, consider supporting its development:

[![Image 9: GitHub Sponsors](https://img.shields.io/badge/Sponsor-GitHub-ea4aaa?logo=github)](https://github.com/sponsors/pablodelucca)[![Image 10: Ko-fi](https://img.shields.io/badge/Support-Ko--fi-ff5e5b?logo=ko-fi)](https://ko-fi.com/pablodelucca)

## Star History

[![Image 11: Star History Chart](https://api.star-history.com/svg?repos=pablodelucca/pixel-agents&type=Date)](https://www.star-history.com/?repos=pablodelucca%2fpixel-agents&type=date&legend=bottom-right)

## License

This project is licensed under the [MIT License](https://github.com/pablodelucca/pixel-agents/blob/HEAD/LICENSE).
