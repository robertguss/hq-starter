...
URL Source: https://platform.claude.com/docs/en/agents-and-tools/agent-skills/best-practices
...
English[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagents-and-tools%2Fagent-skills%2Fbest-practices)
...
![Image 1: Simple SKILL.md file showing YAML frontmatter and markdown body](https://platform.claude.com/docs/images/agent-skills-simple-file.png)

As your Skill grows, you can bundle additional content that Claude loads only when needed:

![Image 2: Bundling additional reference files like reference.md and forms.md.](https://platform.claude.com/docs/images/agent-skills-bundling-content.png)
...
![Image 3: Bundling executable scripts alongside instruction files](https://platform.claude.com/docs/images/agent-skills-executable-scripts.png)
...
*   - [x] Scripts solve problems rather than punt to Claude
*   - [x] Error handling is explicit and helpful
*   - [x] No "voodoo constants" (all values justified)
*   - [x] Required packages listed in instructions and verified as available
*   - [x] Scripts have clear documentation
*   - [x] No Windows-style paths (all forward slashes)
*   - [x] Validation/verification steps for critical operations
*   - [x] Feedback loops included for quality-critical tasks

### Testing

*   - [x] At least three evaluations created
*   - [x] Tested with Haiku, Sonnet, and Opus
*   - [x] Tested with real usage scenarios
*   - [x] Team feedback incorporated (if applicable)
