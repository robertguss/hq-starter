...
url: "https://skills.sh/browserbase/skills/ui-test?utm_source=www.theunwindai.com&utm_medium=newsletter&utm_campaign=karpathy-s-autoresearch-for-agent-engineering&_bhlid=fa2f80e31f37057915be813df37b94d358d9e6ae"
company: [personal]
topics: []
created: 2026-04-06
source_type: raindrop
raindrop_id: 1674985593
...
Install the ui-test skill for browserbase/skills
...
URL Source: https://skills.sh/browserbase/skills/ui-test?_bhlid=fa2f80e31f37057915be813df37b94d358d9e6ae
...
1.   Read the HTML template at [references/report-template.html](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/report-template.html)
...
1.   For each test result, generate a `<details>` card. Failed tests should be **open by default** so reviewers see them immediately:
...
1.   **Embed screenshots as base64** so the HTML is fully self-contained:
...
1.   Write the final HTML to `.context/ui-test-report.html`:
...
1.   Tell the user: `Report saved to .context/ui-test-report.html` and offer to open it.
...
Apply these to every interactive element you test. Read [references/adversarial-patterns.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/adversarial-patterns.md) for the full pattern library (forms, modals, navigation, error states, keyboard accessibility).
...
For the exact `browse eval` recipes, read [references/browser-recipes.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/browser-recipes.md).
...
Read [references/parallel-testing.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/parallel-testing.md) for the full workflow: session setup, agent fan-out, cookie-sync for auth, and result merging.

## Design Consistency

Check whether changed UI matches the rest of the app visually. Read [references/design-consistency.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/design-consistency.md) when doing visual or design checks.
...
*   **Adversarial patterns** — [references/adversarial-patterns.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/adversarial-patterns.md) — load when testing forms, modals, navigation, or keyboard a11y
*   **Browser recipes** — [references/browser-recipes.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/browser-recipes.md) — load when running deterministic checks (axe-core, console, images, form labels)
*   **Exploratory testing** — [references/exploratory-testing.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/exploratory-testing.md) — load for Workflow B (no diff, open exploration)
*   **UX heuristics** — [references/ux-heuristics.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/ux-heuristics.md) — load when evaluating UX quality or citing specific heuristics
*   **Design system** — [references/design-system.example.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/design-system.example.md) — template for users to customize
*   **Design consistency** — [references/design-consistency.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/design-consistency.md) — load when doing visual consistency checks
*   **Parallel testing** — [references/parallel-testing.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/parallel-testing.md) — load for Workflow C (concurrent sessions)
*   **Report template** — [references/report-template.html](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/references/report-template.html) — HTML template for Phase 7 report generation

For worked examples with exact commands, read [EXAMPLES.md](https://github.com/browserbase/skills/blob/HEAD/skills/ui-test/EXAMPLES.md) if you need to see the assertion protocol in action.
